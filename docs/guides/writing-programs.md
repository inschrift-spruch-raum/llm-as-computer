...
```python
from llm_as_computer.isa import Instruction, OP_PUSH, OP_DUP, OP_SUB, OP_JNZ, OP_HALT
from llm_as_computer.executor import NumPyExecutor
...
```python
from llm_as_computer.isa import Instruction, OP_PUSH, OP_DUP, OP_JZ, OP_SUB, OP_MUL
from llm_as_computer.isa import OP_LOCAL_SET, OP_LOCAL_GET, OP_CALL, OP_RETURN, OP_HALT
from llm_as_computer.executor import NumPyExecutor
...
from llm_as_computer.programs import make_factorial
...
```python
from llm_as_computer.isa import Instruction
from llm_as_computer.isa import OP_PUSH, OP_CALL, OP_RETURN, OP_HALT, OP_LOCAL_GET
from llm_as_computer.isa import OP_LOCAL_SET, OP_SUB, OP_MUL, OP_DUP, OP_NOP
from llm_as_computer.executor import NumPyExecutor
...
```python
from llm_as_computer.isa import Instruction
from llm_as_computer.isa import (OP_PUSH, OP_HALT, OP_ADD, OP_SUB, OP_DUP, OP_JZ, OP_JNZ,
...
```python
from llm_as_computer.programs import make_fibonacci, make_factorial, make_gcd, make_multiply
from llm_as_computer.executor import NumPyExecutor
...
```python
from llm_as_computer.isa import Instruction, compare_traces
from llm_as_computer.executor import NumPyExecutor, TorchExecutor
from llm_as_computer.programs import make_factorial
...
```python
# 溢出示例
from llm_as_computer.isa import Instruction, OP_PUSH, OP_ADD, OP_HALT, MASK32
from llm_as_computer.executor import NumPyExecutor
