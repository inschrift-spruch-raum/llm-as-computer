...
BENCHMARKS = [
    ("fnv1a_32", _fnv1a_prog, _fnv1a_exp, "FNV-1a hash of bytes 0..31"),
    ("bubble_20", _bubble_prog, _bubble_exp, "bubble sort 20-element array"),
    ("primes_100", _primes_prog, _primes_exp, "sum of primes up to 100"),
]
